...
@section('contenu')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Ajouter un model acte</h4>
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($.fn.DataTable.isDataTable('#liste_modelacte')) {
                $('#liste_modelacte').DataTable().destroy();
            }
            var oTable = $('#liste_modelacte').DataTable({
                processing: true,
                serverSide: true,
